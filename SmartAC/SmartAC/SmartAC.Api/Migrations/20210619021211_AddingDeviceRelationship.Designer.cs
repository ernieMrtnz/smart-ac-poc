...
namespace SmartAC.Api.Migrations
{
    ...
    [Migration("20210619021211_AddingDeviceRelationship")]
    partial class AddingDeviceRelationship
    {
            ...
            modelBuilder.Entity("SmartAC.Api.DataAccess.Entities.DeviceDetail", b =>
                {
                    b.HasOne("SmartAC.Api.DataAccess.Entities.Device", "Device")
                        ...
                        .HasForeignKey("SmartAC.Api.DataAccess.Entities.DeviceDetail", "DeviceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
